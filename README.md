...
| [`golangci-lint`](https://github.com/golangci/golangci-lint)          | `v1.64.8`             |
| [`govulncheck`](https://pkg.go.dev/golang.org/x/vuln/cmd/govulncheck) | `v1.1.4`              |
| [`deadcode`](https://pkg.go.dev/golang.org/x/tools/cmd/deadcode)      | `v0.33.0`             |
...
| [`goreleaser/nfpm`](https://github.com/goreleaser/nfpm)                                   | `v2.42.0` |
