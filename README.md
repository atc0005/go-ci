...
| [`golangci-lint`](https://github.com/golangci/golangci-lint)          | `v1.62.0`             |
| [`govulncheck`](https://pkg.go.dev/golang.org/x/vuln/cmd/govulncheck) | `v1.1.3`              |
| [`deadcode`](https://pkg.go.dev/golang.org/x/tools/cmd/deadcode)      | `v0.27.0`             |
...
| [`goreleaser/nfpm`](https://github.com/goreleaser/nfpm)                                   | `v2.41.1` |
