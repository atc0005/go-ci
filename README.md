...
| Linter                                                                | Version             |
| --------------------------------------------------------------------- | ------------------- |
| [`staticcheck`](https://github.com/dominikh/go-tools)                 | `2026.1` (`v0.7.0`) |
| [`golangci-lint`](https://github.com/golangci/golangci-lint)          | `v2.13.2`           |
| [`govulncheck`](https://pkg.go.dev/golang.org/x/vuln/cmd/govulncheck) | `v1.7.0`            |
| [`deadcode`](https://pkg.go.dev/golang.org/x/tools/cmd/deadcode)      | `v0.49.0`           |
...
| [`goreleaser/nfpm`](https://github.com/goreleaser/nfpm)                                   | `v2.47.0` |
