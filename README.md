...
| [`golangci-lint`](https://github.com/golangci/golangci-lint)          | `v1.58.0`             |
| [`govulncheck`](https://pkg.go.dev/golang.org/x/vuln/cmd/govulncheck) | `v1.1.0`              |
...
| [`goreleaser/nfpm`](https://github.com/goreleaser/nfpm)                                   | `v2.37.0` |
