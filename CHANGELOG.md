...
- (GH-2624) General Build Image: Bump amd64/golang from 1.25.12-alpine3.24 to 1.25.13-alpine3.24 in /oldstable/build/alpine-x64
- (GH-2630) General Build Image: Bump amd64/golang from 1.25.12-bookworm to 1.25.13-bookworm in /oldstable/build/cgo-mingw-w64-x64
- (GH-2614) General Build Image: Bump amd64/golang from 1.26.5-alpine3.24 to 1.26.6-alpine3.24 in /stable/build/alpine-x64
- (GH-2625) General Build Image: Bump amd64/golang from 1.26.5-alpine3.24 to 1.26.6-alpine3.24 in /unstable/build/alpine-x64
- (GH-2627) General Build Image: Bump amd64/golang from 1.26.5-bookworm to 1.26.6-bookworm in /stable/build/cgo-mingw-w64-x64
- (GH-2628) General Build Image: Bump amd64/golang from 1.26.5-bookworm to 1.26.6-bookworm in /unstable/build/cgo-mingw-w64-x64
- (GH-2623) General Build Image: Bump i386/golang from 1.25.12-alpine3.24 to 1.25.13-alpine3.24 in /oldstable/build/alpine-x86
- (GH-2629) General Build Image: Bump i386/golang from 1.25.12-bookworm to 1.25.13-bookworm in /oldstable/build/cgo-mingw-w64-x86
- (GH-2615) General Build Image: Bump i386/golang from 1.26.5-alpine3.24 to 1.26.6-alpine3.24 in /stable/build/alpine-x86
- (GH-2626) General Build Image: Bump i386/golang from 1.26.5-alpine3.24 to 1.26.6-alpine3.24 in /unstable/build/alpine-x86
- (GH-2632) General Build Image: Bump i386/golang from 1.26.5-bookworm to 1.26.6-bookworm in /stable/build/cgo-mingw-w64-x86
- (GH-2631) General Build Image: Bump i386/golang from 1.26.5-bookworm to 1.26.6-bookworm in /unstable/build/cgo-mingw-w64-x86
- (GH-2621) Matrix Image: Bump amd64/golang from 1.25.12-bookworm to 1.25.13-bookworm in /oldstable/combined
- (GH-2613) Matrix Image: Bump amd64/golang from 1.26.5-bookworm to 1.26.6-bookworm in /stable/combined
- (GH-2618) Matrix Image: Bump amd64/golang from 1.26.5-bookworm to 1.26.6-bookworm in /unstable/combined
- (GH-2633) Mirror Build Image: Bump amd64/golang from 1.25.12-bookworm to 1.25.13-bookworm in /mirror/1.25
- (GH-2634) Mirror Build Image: Bump amd64/golang from 1.26.5-bookworm to 1.26.6-bookworm in /mirror/1.26
- (GH-2620) Release Build Image: Bump amd64/golang from 1.25.12-bookworm to 1.25.13-bookworm in /oldstable/build/release
- (GH-2619) Release Build Image: Bump amd64/golang from 1.26.5-bookworm to 1.26.6-bookworm in /stable/build/release
- (GH-2622) Release Build Image: Bump amd64/golang from 1.26.5-bookworm to 1.26.6-bookworm in /unstable/build/release
- (GH-2638) Update bitfield/gotestdox to v0.2.3
- (GH-2637) Update golang.org/x/tools/cmd/deadcode to v0.49.0
- (GH-2639) Update golang.org/x/vuln to v1.7.0

### Fixed

- (GH-2636) Update Alpine base image deps
- (GH-2635) Update `tools/alpine-images.sh` helper script

## [v0.23.22] - 2026-07-15

### Changed

- (GH-2588) Add helper scripts for updating version ENVs
- (GH-2582) General Build Image: Bump amd64/golang from 1.25.11-alpine3.24 to 1.25.12-alpine3.24 in /oldstable/build/alpine-x64
- (GH-2569) General Build Image: Bump amd64/golang from 1.25.11-bookworm to 1.25.12-bookworm in /oldstable/build/cgo-mingw-w64-x64
- (GH-2581) General Build Image: Bump amd64/golang from 1.26.4-alpine3.24 to 1.26.5-alpine3.24 in /stable/build/alpine-x64
- (GH-2583) General Build Image: Bump amd64/golang from 1.26.4-alpine3.24 to 1.26.5-alpine3.24 in /unstable/build/alpine-x64
- (GH-2571) General Build Image: Bump amd64/golang from 1.26.4-bookworm to 1.26.5-bookworm in /stable/build/cgo-mingw-w64-x64
- (GH-2567) General Build Image: Bump amd64/golang from 1.26.4-bookworm to 1.26.5-bookworm in /unstable/build/cgo-mingw-w64-x64
- (GH-2584) General Build Image: Bump i386/golang from 1.25.11-alpine3.24 to 1.25.12-alpine3.24 in /oldstable/build/alpine-x86
- (GH-2570) General Build Image: Bump i386/golang from 1.25.11-bookworm to 1.25.12-bookworm in /oldstable/build/cgo-mingw-w64-x86
- (GH-2580) General Build Image: Bump i386/golang from 1.26.4-alpine3.24 to 1.26.5-alpine3.24 in /stable/build/alpine-x86
- (GH-2585) General Build Image: Bump i386/golang from 1.26.4-alpine3.24 to 1.26.5-alpine3.24 in /unstable/build/alpine-x86
- (GH-2568) General Build Image: Bump i386/golang from 1.26.4-bookworm to 1.26.5-bookworm in /stable/build/cgo-mingw-w64-x86
- (GH-2566) General Build Image: Bump i386/golang from 1.26.4-bookworm to 1.26.5-bookworm in /unstable/build/cgo-mingw-w64-x86
- (GH-2565) Matrix Image: Bump amd64/golang from 1.25.11-bookworm to 1.25.12-bookworm in /oldstable/combined
- (GH-2560) Matrix Image: Bump amd64/golang from 1.26.4-bookworm to 1.26.5-bookworm in /stable/combined
- (GH-2561) Matrix Image: Bump amd64/golang from 1.26.4-bookworm to 1.26.5-bookworm in /unstable/combined
- (GH-2573) Mirror Build Image: Bump amd64/golang from 1.25.11-bookworm to 1.25.12-bookworm in /mirror/1.25
- (GH-2572) Mirror Build Image: Bump amd64/golang from 1.26.4-bookworm to 1.26.5-bookworm in /mirror/1.26
- (GH-2564) Release Build Image: Bump amd64/golang from 1.25.11-bookworm to 1.25.12-bookworm in /oldstable/build/release
- (GH-2562) Release Build Image: Bump amd64/golang from 1.26.4-bookworm to 1.26.5-bookworm in /stable/build/release
- (GH-2563) Release Build Image: Bump amd64/golang from 1.26.4-bookworm to 1.26.5-bookworm in /unstable/build/release
- (GH-2608) Update golang.org/x/tools/cmd/deadcode to v0.48.0
- (GH-2607) Update golang.org/x/vuln to v1.6.0
- (GH-2605) Update goreleaser/nfpm to v2.47.0
- (GH-2606) Update pelletier/go-toml to v2.4.3

### Fixed

- (GH-2579) Swap Alpine base image version from 3.22 to 3.24
- (GH-2589) Update Ubuntu base image deps

## [v0.23.21] - 2026-06-09

### Changed

- (GH-2514) General Build Image: Bump amd64/golang from 1.25.10-alpine3.22 to 1.25.11-alpine3.22 in /oldstable/build/alpine-x64
- (GH-2529) General Build Image: Bump amd64/golang from 1.25.10-bookworm to 1.25.11-bookworm in /oldstable/build/cgo-mingw-w64-x64
- (GH-2517) General Build Image: Bump amd64/golang from 1.26.3-alpine3.22 to 1.26.4-alpine3.22 in /stable/build/alpine-x64
- (GH-2512) General Build Image: Bump amd64/golang from 1.26.3-alpine3.22 to 1.26.4-alpine3.22 in /unstable/build/alpine-x64
- (GH-2524) General Build Image: Bump amd64/golang from 1.26.3-bookworm to 1.26.4-bookworm in /stable/build/cgo-mingw-w64-x64
- (GH-2523) General Build Image: Bump amd64/golang from 1.26.3-bookworm to 1.26.4-bookworm in /unstable/build/cgo-mingw-w64-x64
- (GH-2513) General Build Image: Bump i386/golang from 1.25.10-alpine3.22 to 1.25.11-alpine3.22 in /oldstable/build/alpine-x86
- (GH-2518) General Build Image: Bump i386/golang from 1.25.10-bookworm to 1.25.11-bookworm in /oldstable/build/cgo-mingw-w64-x86
- (GH-2516) General Build Image: Bump i386/golang from 1.26.3-alpine3.22 to 1.26.4-alpine3.22 in /stable/build/alpine-x86
- (GH-2515) General Build Image: Bump i386/golang from 1.26.3-alpine3.22 to 1.26.4-alpine3.22 in /unstable/build/alpine-x86
- (GH-2522) General Build Image: Bump i386/golang from 1.26.3-bookworm to 1.26.4-bookworm in /stable/build/cgo-mingw-w64-x86
- (GH-2527) General Build Image: Bump i386/golang from 1.26.3-bookworm to 1.26.4-bookworm in /unstable/build/cgo-mingw-w64-x86
- (GH-2521) Matrix Image: Bump amd64/golang from 1.25.10-bookworm to 1.25.11-bookworm in /oldstable/combined
- (GH-2511) Matrix Image: Bump amd64/golang from 1.26.3-bookworm to 1.26.4-bookworm in /stable/combined
- (GH-2520) Matrix Image: Bump amd64/golang from 1.26.3-bookworm to 1.26.4-bookworm in /unstable/combined
- (GH-2526) Mirror Build Image: Bump amd64/golang from 1.25.10-bookworm to 1.25.11-bookworm in /mirror/1.25
- (GH-2530) Mirror Build Image: Bump amd64/golang from 1.26.3-bookworm to 1.26.4-bookworm in /mirror/1.26
- (GH-2528) Release Build Image: Bump amd64/golang from 1.25.10-bookworm to 1.25.11-bookworm in /oldstable/build/release
- (GH-2525) Release Build Image: Bump amd64/golang from 1.26.3-bookworm to 1.26.4-bookworm in /stable/build/release
- (GH-2519) Release Build Image: Bump amd64/golang from 1.26.3-bookworm to 1.26.4-bookworm in /unstable/build/release
- (GH-2531) Update golang.org/x/tools/cmd/deadcode to v0.45.0
...
- (GH-2432) General Build Image: Bump amd64/golang from 1.25.8-alpine3.22 to 1.25.9-alpine3.22 in /oldstable/build/alpine-x64
- (GH-2435) General Build Image: Bump amd64/golang from 1.25.8-bookworm to 1.25.9-bookworm in /oldstable/build/cgo-mingw-w64-x64
- (GH-2423) General Build Image: Bump amd64/golang from 1.26.1-alpine3.22 to 1.26.2-alpine3.22 in /stable/build/alpine-x64
- (GH-2430) General Build Image: Bump amd64/golang from 1.26.1-alpine3.22 to 1.26.2-alpine3.22 in /unstable/build/alpine-x64
- (GH-2437) General Build Image: Bump amd64/golang from 1.26.1-bookworm to 1.26.2-bookworm in /stable/build/cgo-mingw-w64-x64
- (GH-2434) General Build Image: Bump amd64/golang from 1.26.1-bookworm to 1.26.2-bookworm in /unstable/build/cgo-mingw-w64-x64
- (GH-2431) General Build Image: Bump i386/golang from 1.25.8-alpine3.22 to 1.25.9-alpine3.22 in /oldstable/build/alpine-x86
- (GH-2439) General Build Image: Bump i386/golang from 1.25.8-bookworm to 1.25.9-bookworm in /oldstable/build/cgo-mingw-w64-x86
- (GH-2424) General Build Image: Bump i386/golang from 1.26.1-alpine3.22 to 1.26.2-alpine3.22 in /stable/build/alpine-x86
- (GH-2433) General Build Image: Bump i386/golang from 1.26.1-alpine3.22 to 1.26.2-alpine3.22 in /unstable/build/alpine-x86
- (GH-2436) General Build Image: Bump i386/golang from 1.26.1-bookworm to 1.26.2-bookworm in /stable/build/cgo-mingw-w64-x86
- (GH-2438) General Build Image: Bump i386/golang from 1.26.1-bookworm to 1.26.2-bookworm in /unstable/build/cgo-mingw-w64-x86
- (GH-2428) Matrix Image: Bump amd64/golang from 1.25.8-bookworm to 1.25.9-bookworm in /oldstable/combined
- (GH-2422) Matrix Image: Bump amd64/golang from 1.26.1-bookworm to 1.26.2-bookworm in /stable/combined
- (GH-2427) Matrix Image: Bump amd64/golang from 1.26.1-bookworm to 1.26.2-bookworm in /unstable/combined
- (GH-2440) Mirror Build Image: Bump amd64/golang from 1.25.8-bookworm to 1.25.9-bookworm in /mirror/1.25
- (GH-2441) Mirror Build Image: Bump amd64/golang from 1.26.1-bookworm to 1.26.2-bookworm in /mirror/1.26
- (GH-2429) Release Build Image: Bump amd64/golang from 1.25.8-bookworm to 1.25.9-bookworm in /oldstable/build/release
- (GH-2425) Release Build Image: Bump amd64/golang from 1.26.1-bookworm to 1.26.2-bookworm in /stable/build/release
- (GH-2426) Release Build Image: Bump amd64/golang from 1.26.1-bookworm to 1.26.2-bookworm in /unstable/build/release
- (GH-2446) Update golang.org/x/tools/cmd/deadcode to v0.44.0
...
- (GH-2415) Update golangci-lint to v2.11.4
- (GH-2416) Update pelletier/go-toml to v2.3.0

## [v0.23.16] - 2026-03-19

### Changed

- (GH-2410) Update golang.org/x/tools/cmd/deadcode to v0.43.0
- (GH-2409) Update goreleaser/nfpm to v2.45.2

## [v0.23.15] - 2026-03-11

### Changed

- (GH-2404) Update golangci-lint to v2.11.3
- (GH-2403) Update goreleaser/nfpm to v2.45.1

## [v0.23.14] - 2026-03-06

### Changed

- (GH-2384) General Build Image: Bump amd64/golang from 1.25.7-alpine3.22 to 1.25.8-alpine3.22 in /oldstable/build/alpine-x64
- (GH-2388) General Build Image: Bump amd64/golang from 1.25.7-bookworm to 1.25.8-bookworm in /oldstable/build/cgo-mingw-w64-x64
- (GH-2377) General Build Image: Bump amd64/golang from 1.26.0-alpine3.22 to 1.26.1-alpine3.22 in /stable/build/alpine-x64
- (GH-2387) General Build Image: Bump amd64/golang from 1.26.0-alpine3.22 to 1.26.1-alpine3.22 in /unstable/build/alpine-x64
- (GH-2389) General Build Image: Bump amd64/golang from 1.26.0-bookworm to 1.26.1-bookworm in /stable/build/cgo-mingw-w64-x64
- (GH-2393) General Build Image: Bump amd64/golang from 1.26.0-bookworm to 1.26.1-bookworm in /unstable/build/cgo-mingw-w64-x64
- (GH-2385) General Build Image: Bump i386/golang from 1.25.7-alpine3.22 to 1.25.8-alpine3.22 in /oldstable/build/alpine-x86
- (GH-2392) General Build Image: Bump i386/golang from 1.25.7-bookworm to 1.25.8-bookworm in /oldstable/build/cgo-mingw-w64-x86
- (GH-2376) General Build Image: Bump i386/golang from 1.26.0-alpine3.22 to 1.26.1-alpine3.22 in /stable/build/alpine-x86
- (GH-2386) General Build Image: Bump i386/golang from 1.26.0-alpine3.22 to 1.26.1-alpine3.22 in /unstable/build/alpine-x86
- (GH-2391) General Build Image: Bump i386/golang from 1.26.0-bookworm to 1.26.1-bookworm in /stable/build/cgo-mingw-w64-x86
- (GH-2390) General Build Image: Bump i386/golang from 1.26.0-bookworm to 1.26.1-bookworm in /unstable/build/cgo-mingw-w64-x86
- (GH-2380) Matrix Image: Bump amd64/golang from 1.25.7-bookworm to 1.25.8-bookworm in /oldstable/combined
- (GH-2378) Matrix Image: Bump amd64/golang from 1.26.0-bookworm to 1.26.1-bookworm in /stable/combined
- (GH-2383) Matrix Image: Bump amd64/golang from 1.26.0-bookworm to 1.26.1-bookworm in /unstable/combined
- (GH-2394) Mirror Build Image: Bump amd64/golang from 1.25.7-bookworm to 1.25.8-bookworm in /mirror/1.25
- (GH-2395) Mirror Build Image: Bump amd64/golang from 1.26.0-bookworm to 1.26.1-bookworm in /mirror/1.26
- (GH-2381) Release Build Image: Bump amd64/golang from 1.25.7-bookworm to 1.25.8-bookworm in /oldstable/build/release
- (GH-2379) Release Build Image: Bump amd64/golang from 1.26.0-bookworm to 1.26.1-bookworm in /stable/build/release
- (GH-2382) Release Build Image: Bump amd64/golang from 1.26.0-bookworm to 1.26.1-bookworm in /unstable/build/release
- (GH-2397) Update golangci-lint to v2.11.1
...
- (GH-2331) General Build Image: Bump amd64/golang from 1.24.12-alpine3.22 to 1.24.13-alpine3.22 in /oldstable/build/alpine-x64
- (GH-2336) General Build Image: Bump amd64/golang from 1.24.12-bookworm to 1.24.13-bookworm in /oldstable/build/cgo-mingw-w64-x64
- (GH-2324) General Build Image: Bump amd64/golang from 1.25.6-alpine3.22 to 1.25.7-alpine3.22 in /stable/build/alpine-x64
- (GH-2347) General Build Image: Bump amd64/golang from 1.25.6-alpine3.22 to 1.26.0-alpine3.22 in /unstable/build/alpine-x64
- (GH-2337) General Build Image: Bump amd64/golang from 1.25.6-bookworm to 1.25.7-bookworm in /stable/build/cgo-mingw-w64-x64
- (GH-2349) General Build Image: Bump amd64/golang from 1.25.6-bookworm to 1.26.0-bookworm in /unstable/build/cgo-mingw-w64-x64
- (GH-2330) General Build Image: Bump i386/golang from 1.24.12-alpine3.22 to 1.24.13-alpine3.22 in /oldstable/build/alpine-x86
- (GH-2335) General Build Image: Bump i386/golang from 1.24.12-bookworm to 1.24.13-bookworm in /oldstable/build/cgo-mingw-w64-x86
- (GH-2322) General Build Image: Bump i386/golang from 1.25.6-alpine3.22 to 1.25.7-alpine3.22 in /stable/build/alpine-x86
- (GH-2348) General Build Image: Bump i386/golang from 1.25.6-alpine3.22 to 1.26.0-alpine3.22 in /unstable/build/alpine-x86
- (GH-2334) General Build Image: Bump i386/golang from 1.25.6-bookworm to 1.25.7-bookworm in /stable/build/cgo-mingw-w64-x86
- (GH-2350) General Build Image: Bump i386/golang from 1.25.6-bookworm to 1.26.0-bookworm in /unstable/build/cgo-mingw-w64-x86
- (GH-2325) Matrix Image: Bump amd64/golang from 1.24.12-bookworm to 1.24.13-bookworm in /oldstable/combined
- (GH-2323) Matrix Image: Bump amd64/golang from 1.25.6-bookworm to 1.25.7-bookworm in /stable/combined
- (GH-2345) Matrix Image: Bump amd64/golang from 1.25.6-bookworm to 1.26.0-bookworm in /unstable/combined
- (GH-2340) Mirror Build Image: Bump amd64/golang from 1.24.12-bookworm to 1.24.13-bookworm in /mirror/1.24
- (GH-2341) Mirror Build Image: Bump amd64/golang from 1.25.6-bookworm to 1.25.7-bookworm in /mirror/1.25
- (GH-2327) Release Build Image: Bump amd64/golang from 1.24.12-bookworm to 1.24.13-bookworm in /oldstable/build/release
- (GH-2326) Release Build Image: Bump amd64/golang from 1.25.6-bookworm to 1.25.7-bookworm in /stable/build/release
- (GH-2346) Release Build Image: Bump amd64/golang from 1.25.6-bookworm to 1.26.0-bookworm in /unstable/build/release
...
[v0.23.15]: https://github.com/atc0005/go-ci/releases/tag/v0.23.15
[v0.23.14]: https://github.com/atc0005/go-ci/releases/tag/v0.23.14
