...
DOCKER_IMAGE_NAME_MIRROR_BUILD_GO125		= go-ci-mirror-build-go1.25
DOCKER_IMAGE_NAME_MIRROR_BUILD_GO126		= go-ci-mirror-build-go1.26
DOCKER_IMAGE_NAME_MIRROR_BUILD_GO127		= go-ci-mirror-build-go1.27
...
legacy-mirror-build: pre-build
	...
	@echo "Building $(DOCKER_IMAGE_NAME_MIRROR_BUILD_GO125) release"
	docker image build \
		--pull \
		--no-cache \
		--platform "linux/amd64" \
		mirror/1.25/ \
		-t $(DOCKER_IMAGE_REGISTRY)/$(DOCKER_IMAGE_REGISTRY_USER)/$(DOCKER_IMAGE_REPO):$(DOCKER_IMAGE_NAME_MIRROR_BUILD_GO125) \
		-t $(DOCKER_IMAGE_REGISTRY)/$(DOCKER_IMAGE_REGISTRY_USER)/$(DOCKER_IMAGE_REPO):$(DOCKER_IMAGE_NAME_MIRROR_BUILD_GO125)-$(REPO_VERSION) \
		-t $(GITHUB_IMAGE_REGISTRY)/$(GITHUB_IMAGE_REGISTRY_USER)/$(GITHUB_PROJECT_REPO):$(DOCKER_IMAGE_NAME_MIRROR_BUILD_GO125) \
		-t $(GITHUB_IMAGE_REGISTRY)/$(GITHUB_IMAGE_REGISTRY_USER)/$(GITHUB_PROJECT_REPO):$(DOCKER_IMAGE_NAME_MIRROR_BUILD_GO125)-$(REPO_VERSION) \
		--label=$(DOCKER_IMAGE_OWNER_LABEL) \
		--label=$(DOCKER_IMAGE_REVISION_LABEL) \
		--label=$(DOCKER_IMAGE_CREATED_LABEL)
	@echo "Completed build of $(DOCKER_IMAGE_NAME_MIRROR_BUILD_GO125) release"
...
stable-mirror-build: pre-build
	...
	@echo "Building $(DOCKER_IMAGE_NAME_MIRROR_BUILD_GO126) release"
	docker image build \
		--pull \
		--no-cache \
		--platform "linux/amd64" \
		...
		-t $(DOCKER_IMAGE_REGISTRY)/$(DOCKER_IMAGE_REGISTRY_USER)/$(DOCKER_IMAGE_REPO):$(DOCKER_IMAGE_NAME_MIRROR_BUILD_GO126) \
		-t $(DOCKER_IMAGE_REGISTRY)/$(DOCKER_IMAGE_REGISTRY_USER)/$(DOCKER_IMAGE_REPO):$(DOCKER_IMAGE_NAME_MIRROR_BUILD_GO126)-$(REPO_VERSION) \
		...
		-t $(GITHUB_IMAGE_REGISTRY)/$(GITHUB_IMAGE_REGISTRY_USER)/$(GITHUB_PROJECT_REPO):$(DOCKER_IMAGE_NAME_MIRROR_BUILD_GO126) \
		-t $(GITHUB_IMAGE_REGISTRY)/$(GITHUB_IMAGE_REGISTRY_USER)/$(GITHUB_PROJECT_REPO):$(DOCKER_IMAGE_NAME_MIRROR_BUILD_GO126)-$(REPO_VERSION) \
		--label=$(DOCKER_IMAGE_OWNER_LABEL) \
		--label=$(DOCKER_IMAGE_REVISION_LABEL) \
		--label=$(DOCKER_IMAGE_CREATED_LABEL)
	@echo "Completed build of $(DOCKER_IMAGE_NAME_MIRROR_BUILD_GO126) release"

	@echo "Building $(DOCKER_IMAGE_NAME_MIRROR_BUILD_GO127) release"
	docker image build \
		--pull \
		--no-cache \
		--platform "linux/amd64" \
		...
		-t $(DOCKER_IMAGE_REGISTRY)/$(DOCKER_IMAGE_REGISTRY_USER)/$(DOCKER_IMAGE_REPO):$(DOCKER_IMAGE_NAME_MIRROR_BUILD_GO127) \
		-t $(DOCKER_IMAGE_REGISTRY)/$(DOCKER_IMAGE_REGISTRY_USER)/$(DOCKER_IMAGE_REPO):$(DOCKER_IMAGE_NAME_MIRROR_BUILD_GO127)-$(REPO_VERSION) \
		...
		-t $(GITHUB_IMAGE_REGISTRY)/$(GITHUB_IMAGE_REGISTRY_USER)/$(GITHUB_PROJECT_REPO):$(DOCKER_IMAGE_NAME_MIRROR_BUILD_GO127) \
		-t $(GITHUB_IMAGE_REGISTRY)/$(GITHUB_IMAGE_REGISTRY_USER)/$(GITHUB_PROJECT_REPO):$(DOCKER_IMAGE_NAME_MIRROR_BUILD_GO127)-$(REPO_VERSION) \
		--label=$(DOCKER_IMAGE_OWNER_LABEL) \
		--label=$(DOCKER_IMAGE_REVISION_LABEL) \
		--label=$(DOCKER_IMAGE_CREATED_LABEL)
	@echo "Completed build of $(DOCKER_IMAGE_NAME_MIRROR_BUILD_GO127) release"
...
upload-mirror-images:
	...
	@docker push $(GITHUB_IMAGE_REGISTRY)/$(GITHUB_IMAGE_REGISTRY_USER)/$(DOCKER_IMAGE_REPO):$(DOCKER_IMAGE_NAME_MIRROR_BUILD_GO125)
	@docker push $(GITHUB_IMAGE_REGISTRY)/$(GITHUB_IMAGE_REGISTRY_USER)/$(DOCKER_IMAGE_REPO):$(DOCKER_IMAGE_NAME_MIRROR_BUILD_GO125)-$(REPO_VERSION)
	@docker push $(GITHUB_IMAGE_REGISTRY)/$(GITHUB_IMAGE_REGISTRY_USER)/$(DOCKER_IMAGE_REPO):$(DOCKER_IMAGE_NAME_MIRROR_BUILD_GO126)
	@docker push $(GITHUB_IMAGE_REGISTRY)/$(GITHUB_IMAGE_REGISTRY_USER)/$(DOCKER_IMAGE_REPO):$(DOCKER_IMAGE_NAME_MIRROR_BUILD_GO126)-$(REPO_VERSION)
	@docker push $(GITHUB_IMAGE_REGISTRY)/$(GITHUB_IMAGE_REGISTRY_USER)/$(DOCKER_IMAGE_REPO):$(DOCKER_IMAGE_NAME_MIRROR_BUILD_GO127)
	@docker push $(GITHUB_IMAGE_REGISTRY)/$(GITHUB_IMAGE_REGISTRY_USER)/$(DOCKER_IMAGE_REPO):$(DOCKER_IMAGE_NAME_MIRROR_BUILD_GO127)-$(REPO_VERSION)
	...
	@docker push $(DOCKER_IMAGE_REGISTRY)/$(DOCKER_IMAGE_REGISTRY_USER)/$(DOCKER_IMAGE_REPO):$(DOCKER_IMAGE_NAME_MIRROR_BUILD_GO125)
	@docker push $(DOCKER_IMAGE_REGISTRY)/$(DOCKER_IMAGE_REGISTRY_USER)/$(DOCKER_IMAGE_REPO):$(DOCKER_IMAGE_NAME_MIRROR_BUILD_GO125)-$(REPO_VERSION)
	@docker push $(DOCKER_IMAGE_REGISTRY)/$(DOCKER_IMAGE_REGISTRY_USER)/$(DOCKER_IMAGE_REPO):$(DOCKER_IMAGE_NAME_MIRROR_BUILD_GO126)
	@docker push $(DOCKER_IMAGE_REGISTRY)/$(DOCKER_IMAGE_REGISTRY_USER)/$(DOCKER_IMAGE_REPO):$(DOCKER_IMAGE_NAME_MIRROR_BUILD_GO126)-$(REPO_VERSION)
	@docker push $(DOCKER_IMAGE_REGISTRY)/$(DOCKER_IMAGE_REGISTRY_USER)/$(DOCKER_IMAGE_REPO):$(DOCKER_IMAGE_NAME_MIRROR_BUILD_GO127)
	@docker push $(DOCKER_IMAGE_REGISTRY)/$(DOCKER_IMAGE_REGISTRY_USER)/$(DOCKER_IMAGE_REPO):$(DOCKER_IMAGE_NAME_MIRROR_BUILD_GO127)-$(REPO_VERSION)
